...
async def new_member(message: Message):
	await message.reply("+ раб 🤑\n\n<i>Керівник гуртка (Шатківський В. М.) не має ніякого відношення до цього повідомлення. Автор даного бота максимально засуджує рабство та інші дії, пов'язані з позбавленням людини певних прав. Саме повідомлення було відправлене без мети образити кого-небудь. Відповідальність за це повідомлення та збиток, який воно може нанести, повністю лежить на @Artemka1806</i>")
